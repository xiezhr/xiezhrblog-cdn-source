					...
					if (k.skip = k.size, o && o.length) {
						...
						o.forEach(function (t) {
							...
							(e && e.results || []).forEach(function (e) {
								I(e, (0, y.default)('.vquote[data-self-id="' + e.get("rid") + '"]'))
							}).catch(function (e) {})
						}), t * n < r ? A.show() : A.hide()
					} else e.$nodata.show();
					e.$loading.hide()
			...
			var I = function (t, n, r) {
				...
				P = function (t, n) {
					t.on("click", function (r) {
						...
						(0, y.default)('.vreply-wrapper[data-self-id="' + i + '"]').append(a).find(".cancel-reply").show(), C = {
			...
			var z = e.$el.find(".vsubmit"),
				...
				U = function () {
					...
					for (var o in E)
						...
						try {
							C.rid ? I(t, (0, y.default)('.vquote[data-self-id="' + C.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), I(t, e.$el.find(".vcards")), k.skip++), z.removeAttr("disabled"), e.$loading.hide(), e.reset()
						} catch (t) {
							(0, $.default)(e, t, "save")
						}
					}).catch(function (t) {
